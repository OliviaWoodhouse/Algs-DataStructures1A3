 ...
 */ 		
 		String fileName = "/Users/oliviawoodhouse/Library/Mobile Documents/com~apple~CloudDocs/COMP 250/Assignment 3/bodybuilding";
    ...
    //    For debugging, we suggest you use a smaller set of words such as the ones shown in the PDF.      
		...
		System.out.println("Number of Prefix Matches: " + wordTree.getListPrefixMatches("").size() + " words");
